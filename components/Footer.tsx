...
export default function Footer() {
    return (
        <footer className="min-h-80 bg-very-dark-violet text-grayish-violet lg:px-36 py-[10%] md:py-[5%] flex flex-col md:flex-row items-center md:items-start justify-between">
            <div className="mb-16">
            ...
            <div className="flex gap-16 xl:gap-24 flex-col md:flex-row">
